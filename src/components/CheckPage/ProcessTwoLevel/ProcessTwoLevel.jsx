...
const ProcessTwoLevel = ({state,sendData,deleteProcessTwoLevel}) => {
    console.log(state);
    return (
                ...
                (formik => (
                    <Box>
                        <form onSubmit={formik.handleSubmit}>
                            <Box>
                                <Typography variant="h5">Процесс 2-го уровня</Typography>
                            </Box>
                            ...
                            <Box display='flex' alignItems='center' justifyContent='flex-end' height={200} mt={3} mr={7}>
                                {state.id ? <Button onClick={deleteProcessTwoLevel}>Удалить</Button> : null}
...
export default ProcessTwoLevel;